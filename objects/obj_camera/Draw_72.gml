...
if (!surface_exists(surface_shadows)) {
    surface_shadows = surface_create(shadow_tex_ww, shadow_tex_hh);
}
if (!surface_exists(surface_draw)) {
    surface_draw = surface_create(window_get_width(), window_get_height());
}
