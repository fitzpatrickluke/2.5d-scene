...
shader_set_uniform_f_array(shader_get_uniform(shader_test_light_3,"u_lightViewMap"), light_view_mat);
shader_set_uniform_f_array(shader_get_uniform(shader_test_light_3,"u_lightProjMap"), light_proj_mat);
texture_set_stage(shader_get_sampler_index(shader_test_light_3, "s_DepthTexture"), surface_get_texture(shadowmap_surface));
